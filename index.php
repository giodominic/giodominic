...
<body>
        ...
        <ul class="nav">
            <li>
                <a class="nav-link" href="index.php">
                    <p style="color: black" class="fw-medium">WORKS</p>
                </a>
            </li>
            <li>
    ...
    <div class="content-div">
        <img src="image/gio.png" class="me" alt="">

        <div class="separator"></div>

        <div class="content-text">
            <h3 class="hi-im-gio fw-bold fs-3">Hi, I'm Gio!</h3>
            <p>I’m a self-taught UI/UX Designer who brings inclusive, minimal & future-oriented user experience to users in need.</p>
        </div>
    </div>
    ...
    <div class="table-div">
        <table>
            <tr>
                <td>
                    <a href="1.php">
                        <img src="image/image1.png" class="image1">
                        <p>&#9989 &nbsp; Productivity App</p>
                    </a>
                </td>
                <td>
                    <a href="2.php">
                        <img src="image/image2.png" class="image2">
                        <p>&#128172 &nbsp; Talk-talk Mobile App</p>
                    </a>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <a href="3.php">
                        <img src="image/image3.png" class="image3">
                        <p>&#x1f5e3 &nbsp; Talk-talk Web App</p>
                    </a>
                </td>
                <td>
                    <a href="4.php">
                        <img src="image/image4.png" class="image4">
                        <p>&#x1f3e7 &nbsp; BDO App (Minimal Revision)</p>
                    </a>
                </td>
            </tr>
        </table>
